...
public:
    typedef Triangle* Pyramide::* SidePtr;
    Pyramide(const double x1 = 0, const double y1 = 0, const double z1 = 0, 
        const double x2 = 1,const double y2 = 0, const double z2 = 0, 
        const double x3 = 0, const double y3 = 1, const double z3 = 0,
